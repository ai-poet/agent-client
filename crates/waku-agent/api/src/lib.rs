...
pub mod client {
    ...
    impl AnthropicClient {
        ...
        /// Build a new client. An empty key is allowed; validation is
        /// deferred to the first call. See [`crate::bun_tls`] for why this
        /// fork builds a plain `reqwest` client rather than the
        /// fingerprint-matched one upstream uses.
