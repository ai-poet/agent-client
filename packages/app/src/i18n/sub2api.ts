...
export const sub2apiMessages = {
  zh: {
    ...
    modeSelect: {
      ...
      developerDescription: "保留完整开发者体验：项目、分支、终端、diff、worktree 和 agent 控制都照常可见。",
      developerMeta: "进入现有 Paseo 开发者模式",
      simpleTitle: "普通用户",
      simpleDescription: "进入极简任务客户端：用任务列表和大输入框管理 Claude / Codex，不展示开发术语。",
      simpleMeta: "进入极简模式",
      title: "你想如何连接？",
    ...
    simpleMode: {
      ...
      startTask: "开始任务",
      creating: "正在创建…",
      promptPlaceholder: "告诉助手你想完成什么。可以是整理资料、写文档、分析文件、规划行程或处理任何本地任务。",
