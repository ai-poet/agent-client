...
export const sub2apiMessages = {
  zh: {
    ...
    agentTools: {
      ...
      details: {
        ...
        output: "输出",
        error: "错误",
        preparingWorktree: (branchName: string, worktreePath: string) =>
          `正在准备 worktree ${branchName}：${worktreePath}`,
      ...
      progress: {
        ...
        generating: "生成回复中",
        working: "处理中",
        tokens: (value: string, isEstimate: boolean) => `${isEstimate ? "≈" : ""}${value} tokens`,
      },
      group: {
    ...
    simpleMode: {
      ...
      useThisFolder: "使用这个位置",
      noTasksTitle: "还没有任务",
      noTasksHint: "在上方输入你想完成的事，助手会把进度和结果保存在任务里。",
      untitledTask: "未命名任务",
      needsApproval: "待确认",
      defaultModel: "默认模型",
      modelNotReady: "正在准备助手",
      modelSummary: (provider: string, model: string) => `${provider} · ${model}`,
      status: {
        initializing: "准备中",
        idle: "空闲",
        running: "进行中",
      ...
      errors: {
        chooseFolder: "请先选择保存资料的位置。",
        hostNotConnected: "本地助手尚未连接。",
        selectModel: "请先完成模型配置。",
        failedCreate: "创建任务失败。",
      },
    },
    simplePermissions: {
    ...
    sidebar: {
      ...
      skillLibraryContentSubtitle: "本地技能 · Claude / Codex · SkillsMP",
      skillRefresh: "刷新",
      skillRefreshing: "正在刷新",
      skillSearchPlaceholder: "搜索技能",
      skillNew: "新技能",
      skillEditable: "可编辑",
      skillSelectSkill: "选择一个技能或新建技能",
      skillImportZip: "导入 Zip",
      skillNameLabel: "技能名称",
      skillSave: "保存",
      skillSaving: "保存中",
      skillDelete: "删除",
      skillOpen: "打开",
      skillWorkspaceRequired: "请先选择一个工作区。",
      skillSaveConflict: (name: string) => `${name} 已存在。确认覆盖后再保存。`,
      skillSaveSuccess: (name: string) => `${name} 已保存。重新加载运行中的 agent 后即可使用。`,
      skillImportZipSuccess: (name: string) => `${name} 已导入。`,
      skillDeleteSuccess: (name: string) => `${name} 已删除。`,
      skillDeleteConfirmTitle: "删除技能",
      skillDeleteConfirmMessage: (name: string) =>
        `确定要删除 ${name} 吗？此操作会删除整个技能目录。`,
      skillOpenFailed: "无法打开此技能页面。",
      skillInstalled: "已安装",
      skillInstall: "安装",
      skillInstalling: "安装中",
      ...
      skillLocalSkills: "本地技能",
      skillMarketplaceSkills: "市场技能",
      skillMarketplaceAtoZ: (count: number) => `${count} · A-Z`,
      skillNoLocalSkills: "未找到本地技能",
      skillNoWorkspace: "选择一个工作区后即可安装技能",
      skillNoWorkspaces: "暂无工作区",
      skillScopeWorkspace: "工作区",
      skillScopeGlobal: "全局",
      skillPermissions: {
        network: "网络",
        filesystem: "文件系统",
        subprocess: "子进程",
        envVars: (count: number) => `${count} 个环境变量`,
        none: "无需提升权限",
      },
      skillStats: {
        updatedRecently: "最近更新",
        daysSinceUpdate: (days: number) => `${days} 天前更新`,
        summary: (trust: string, downloads: number, downloads7d: number, age: string) =>
          `${trust} · ${downloads} 次下载 · 7 天 ${downloads7d} 次 · ${age}`,
      },
      closeSkillLibrary: "关闭 Skill Library",
      settings: "设置",
      sort: "排序",
      sortByProject: "按项目",
      sortByTime: "按时间",
    ...
    sidebarWorkspace: {
      ...
      configureColleague: "配置同事",
      saveColleague: "保存同事",
      savingColleague: "保存中...",
      resetColleague: "重置",
      colleagueSaved: "同事配置已保存",
      failedConfigureColleague: "配置同事失败",
      workspaceNotFound: "找不到工作区",
      colleagueWorktreeOnly: "只有 Paseo 工作树可以配置同事",
      rolePickerHint: "选择角色会自动套用该角色的默认技能。",
      path: "路径",
    },
    openProject: {
      heading: "今天想构建什么？",
    ...
    draftAgent: {
      title: "代理",
      heroTitle: (workspaceName: string) => `要在 ${workspaceName} 中构建什么？`,
    ...
    agentForm: {
      ...
      colleague: "同事",
      colleagueRole: "同事角色",
      selectColleagueRole: "选择同事角色",
      skills: "技能",
      selectSkills: "选择技能",
      noSkillsSelected: "未选择技能",
      skillsHelper: "这些技能会写入工作树，供代理原生发现。",
    ...
    workspace: {
      ...
      commitGraph: {
        title: "Git 图谱",
        changedFiles: "变更文件",
        fileListUnavailable: "当前 daemon 尚未提供文件列表。",
        copyCommitHash: "复制提交哈希",
        copyRefs: "复制引用",
        openChangedFiles: "打开变更文件",
        fileListNeedsDaemon: "提交文件列表需要 daemon 支持",
        failedLoad: "加载提交图谱失败",
        searchPlaceholder: "搜索提交",
        clearSearch: "清除提交图谱搜索",
        refresh: "刷新",
        locateHead: "定位 HEAD",
        hideRefs: "隐藏引用",
        showRefs: "显示引用",
        noCommits: "没有提交",
        noMatchingCommits: "没有匹配的提交",
        description: "描述",
        date: "日期",
        author: "作者",
        commit: "提交",
      ...
      openPreviewExternal: "在浏览器中打开预览",
      previewUnavailable: "此服务当前无法预览。",
      previewUnavailableNative: "浏览器预览仅在桌面端可用。",
      viewScriptTerminal: (scriptName: string) => `查看 ${scriptName} 终端`,
      runScript: (scriptName: string) => `运行 ${scriptName} 脚本`,
      previewScript: (scriptName: string) => `预览 ${scriptName} 服务`,
    ...
    gitDiff: {
      ...
      commitFilesLabel: "提交文件",
      commitFilesSelected: (selected: number, total: number) =>
        `已选择 ${selected}/${total} 个文件`,
      commitFilesRequired: "请选择至少一个文件",
      selectAllCommitFiles: "全选",
      clearCommitFiles: "清空",
      hostNotConnected: "主机未连接",
      magicCommitAction: "让 agent 自动提交",
      magicCommitSent: "已交给 agent 提交",
      magicCommitFailed: "无法发送自动提交请求",
      magicCommitNoFocusedAgent: "请先聚焦此工作区中的一个 agent",
      magicCommitUnsupported: "当前主机版本不支持隐藏发送",
      newFileBadge: "新增",
      deletedFileBadge: "删除",
      binaryFileBadge: "二进制",
      cancelCommit: "取消",
    ...
    settings: {
      ...
      resetEnvironmentTitle: "重置 Paseo",
      resetEnvironmentHint:
        "清空此设备上的 Paseo 应用和 daemon 状态，重新回到首次打开流程。不会删除你的项目仓库或外部代理登录密钥。",
      resetEnvironmentAction: "重置",
      resettingEnvironment: "重置中…",
      resetEnvironmentConfirmMessage:
        "这会停止内置 daemon，并清空此设备上的 Paseo 主机、代理、工作树记录、草稿、附件缓存和设置。你的项目仓库不会被删除。",
      resetEnvironmentFailed: (message: string) => `重置失败：${message}`,
      shortcuts: {
        title: "快捷键",
      ...
      providers: {
        ...
        installing: "安装中…",
        installFailed: "安装失败",
        installSucceeded: (name: string, version: string) =>
          `${name} 安装完成，当前版本 ${version}`,
        installSucceededUnknownVersion: (name: string) => `${name} 安装完成`,
        installNotDetected: (name: string) =>
          `${name} 安装命令已完成，但仍未检测到可执行文件，请查看下方诊断信息`,
        installUnchanged: (name: string, version: string) =>
          `${name} 安装命令已完成，但版本仍为 ${version}`,
        installOnDesktopOnly: "自动安装仅在桌面端可用。请复制下方命令，在这台主机的终端里执行。",
        diagnostic: "诊断",
        ...
        capabilityLabels: {
          ...
          supportsSessionPersistence: "恢复会话",
          supportsDynamicModes: "动态模式",
          supportsMcpServers: "MCP",
          supportsReasoningStream: "思考过程",
          supportsToolInvocations: "工具调用",
        },
        supported: "支持",
        unsupported: "不支持",
      },
      externalImport: {
        title: "导入外部渠道",
        subtitle: "只读导入 cc-switch 与 Cherry Studio 中已配置的端点，不会修改这些应用的数据。",
        sources: { ccswitch: "cc-switch", "cherry-studio": "Cherry Studio" },
        notDetected: "未检测到",
        readFrom: (path: string) => `读取自 ${path}`,
        scan: "扫描",
        scanning: "扫描中…",
        nothingFound: "没有发现可导入的渠道",
        nothingFoundHint: "确认这些应用已安装并至少配置过一个端点。",
        alreadyImported: "已导入",
        willOverwrite: "将覆盖",
        noApiKey: "未配置密钥",
        modelCount: (count: number) => `${count} 个模型`,
        selected: (count: number) => `已选择 ${count} 个`,
        import: (count: number) => `导入 ${count} 个`,
        confirmOverwrite: "确认覆盖并导入",
        overwriteHint: (count: number) =>
          `已选择的渠道中有 ${count} 个与现有端点同名。再次点击将覆盖它们的地址与密钥，但保留默认状态。`,
        imported: (count: number) => `已导入 ${count} 个渠道`,
        importFailed: "导入失败",
        clear: "清空",
      },
      automation: {
        title: "自动化",
        subtitle: "按计划在后台创建 Agent 任务，运行结果保留为普通会话。",
        unsupported: "连接到本机守护进程后可管理自动化。",
        empty: "还没有自动化",
        emptyHint: "创建一条计划，让 Agent 定时替你跑任务。",
        loadFailed: "读取自动化失败",
        create: "新建",
        creating: "创建中…",
        cancel: "取消",
        save: "保存",
        namePlaceholder: "例如：每天检查依赖更新",
        promptPlaceholder: "清楚描述 Agent 每次要完成的任务、边界和输出要求",
        nameLabel: "名称",
        promptLabel: "任务内容",
        cadenceLabel: "执行计划",
        kinds: {
        ...
        dayOfMonthLabel: "每月",
        dayOfMonthSuffix: "日",
        timezoneNote: (zone: string) => `按本机时区 ${zone} 运行；应用退出期间不会唤醒执行。`,
        nextRun: (time: string) => `下次运行：${time}`,
        nextRunUnknown: "下次运行时间待定",
        paused: "已停用",
        active: "已启用",
        pause: "停用",
        resume: "启用",
        delete: "删除",
        confirmDelete: "确认删除",
        deleteHint: (name: string) => `再次点击将删除「${name}」，已产生的会话会保留。`,
        lastRun: (time: string) => `上次 ${time}`,
        runStatuses: { running: "运行中", succeeded: "已完成", failed: "失败" },
        promptRequired: "任务内容不能为空",
        weekdayNames: ["周日", "周一", "周二", "周三", "周四", "周五", "周六"],
        summary: {
          everyMinutes: (minutes: number) => `每 ${minutes} 分钟`,
          everyHours: (hours: number) => `每 ${hours} 小时`,
          daily: (time: string) => `每天 ${time}`,
          weekdays: (time: string) => `工作日 ${time}`,
          weekly: (day: string, time: string) => `每${day} ${time}`,
          monthly: (day: number, time: string) => `每月 ${day} 日 ${time}`,
          cron: (expression: string) => `自定义 ${expression}`,
        },
      },
      usage: {
        title: "用量",
        subtitle: "本机所有 Agent 的 token、耗时与费用统计，含自带 key 的流量。",
        unsupported: "当前守护进程还不支持本地用量统计，升级后可用。",
        scope: (range: string, project: string) => `当前统计范围：${range} · ${project}`,
        ranges: { 1: "今日", 7: "7 天", 30: "30 天", 90: "90 天", all: "全部" },
        allProviders: "全部 Agent",
        allProjects: "全部项目",
        refresh: "刷新",
        empty: "还没有用量记录",
        emptyHint: "跑一轮对话后，这里会出现 token、耗时和费用统计。",
        noMatching: "该范围内没有用量记录",
        loadFailed: "读取用量失败",
        cards: {
          turns: "回合",
          turnsHint: (count: number) => `${count} 次工具级请求`,
          tokens: "Token",
          tokensHint: (input: string, output: string) => `输入 ${input} / 输出 ${output}`,
          cached: "缓存读取",
          cachedHint: "命中缓存的输入 token",
          duration: "耗时",
          durationHint: "按完成回合累计",
          cost: "费用",
          costHint: "来自各 Agent 上报的用量",
        },
        trend: "使用趋势",
        trendHint: "随统计范围自动切换日、周或月粒度",
        metrics: { tokens: "Tokens", cost: "费用", duration: "耗时" },
        byProvider: "按 Agent",
        byProject: "按项目",
        noProviderRecords: "暂无 Agent 使用记录",
        noProjectRecords: "暂无项目使用记录",
        bucketSummary: (turns: number) => `${turns} 个回合`,
      },
  ...
  en: {
    ...
    simpleMode: {
      ...
      folderPathPlaceholder: "Enter task folder path",
      useThisFolder: "Use this location",
      noTasksTitle: "No tasks yet",
      noTasksHint: "Describe what you want above; progress and results will stay in the task.",
      untitledTask: "Untitled task",
      needsApproval: "Needs approval",
      defaultModel: "default model",
      modelNotReady: "Preparing assistant",
      modelSummary: (provider: string, model: string) => `${provider} · ${model}`,
      status: {
      ...
      errors: {
        chooseFolder: "Choose where to save task files first.",
        hostNotConnected: "The local assistant is not connected yet.",
        selectModel: "Finish model setup first.",
        failedCreate: "Failed to create task.",
      },
    },
    simplePermissions: {
      confirmPlan: "Confirm the task plan",
      readFiles: "Allow the assistant to read files",
      changeFiles: "Allow the assistant to change files",
      runCommand: "Allow the assistant to run a command",
      approval: "The assistant needs your approval",
      deny: "Don't allow",
      allow: "Allow",
      start: "Start",
    ...
    sidebar: {
      ...
      skillLibraryContentSubtitle: "Local skills · Claude / Codex · SkillsMP",
      skillRefresh: "Refresh",
      skillRefreshing: "Refreshing",
      skillSearchPlaceholder: "Search skills",
      skillNew: "New skill",
      skillEditable: "Editable",
      skillSelectSkill: "Select a skill or create one",
      skillImportZip: "Import Zip",
      skillNameLabel: "Skill name",
      skillSave: "Save",
      skillSaving: "Saving",
      skillDelete: "Delete",
      skillOpen: "Open",
      skillWorkspaceRequired: "Choose a workspace first.",
      skillSaveConflict: (name: string) =>
        `${name} already exists. Confirm overwrite before saving.`,
      skillSaveSuccess: (name: string) => `${name} saved. Reload running agents to pick it up.`,
      skillImportZipSuccess: (name: string) => `${name} imported.`,
      skillDeleteSuccess: (name: string) => `${name} deleted.`,
      skillDeleteConfirmTitle: "Delete skill",
      skillDeleteConfirmMessage: (name: string) =>
        `Delete ${name}? This removes the entire skill directory.`,
      skillOpenFailed: "Unable to open this skill page.",
      skillInstalled: "Installed",
      skillInstall: "Install",
      skillInstalling: "Installing",
      skillInstallWorkspaceRequired: "Open a workspace before installing skills.",
      ...
      skillSource: "Source",
      skillLicense: "License",
      skillLocalSkills: "Local skills",
      skillMarketplaceSkills: "Marketplace skills",
      skillMarketplaceAtoZ: (count: number) => `${count} · A-Z`,
      skillNoLocalSkills: "No local skills found",
      skillNoWorkspace: "Choose a workspace to install skills",
      skillNoWorkspaces: "No workspaces",
      ...
      skillPermissions: {
        ...
        envVars: (count: number) => `${count} env vars`,
        none: "No elevated permissions",
      },
      skillStats: {
        updatedRecently: "updated recently",
        daysSinceUpdate: (days: number) => `${days}d since update`,
        summary: (trust: string, downloads: number, downloads7d: number, age: string) =>
          `${trust} · ${downloads} downloads · ${downloads7d}/7d · ${age}`,
      },
      closeSkillLibrary: "Close Skill Library",
      settings: "Settings",
      sort: "Sort",
    ...
    sidebarWorkspace: {
      ...
      configureColleague: "Configure colleague",
      saveColleague: "Save colleague",
      savingColleague: "Saving...",
      resetColleague: "Reset",
      colleagueSaved: "Colleague saved",
      failedConfigureColleague: "Failed to configure colleague",
      workspaceNotFound: "Workspace not found",
      colleagueWorktreeOnly: "Only Paseo worktrees can be configured as colleagues",
      rolePickerHint: "Choosing a role applies that role's default skills.",
      path: "Path",
    },
    openProject: {
    ...
    draftAgent: {
      title: "Agent",
      heroTitle: (workspaceName: string) => `What do you want to build in ${workspaceName}?`,
    ...
    agentForm: {
      ...
      selectColleagueRole: "Select colleague role",
      skills: "Skills",
      selectSkills: "Select skills",
      noSkillsSelected: "No skills selected",
      skillsHelper: "These skills are written into the worktree for native agent discovery.",
    ...
    workspace: {
      ...
      commitGraph: {
        ...
        fileListUnavailable: "File list is not available from this daemon yet.",
        copyCommitHash: "Copy commit hash",
        copyRefs: "Copy refs",
        openChangedFiles: "Open changed files",
        fileListNeedsDaemon: "Commit file list needs daemon support",
        failedLoad: "Failed to load commit graph",
        searchPlaceholder: "Search commits",
        clearSearch: "Clear commit graph search",
        refresh: "Refresh",
      ...
      openPreviewExternal: "Open preview in browser",
      previewUnavailable: "This service is not available for preview.",
      previewUnavailableNative: "Browser preview is only available on desktop.",
      viewScriptTerminal: (scriptName: string) => `View ${scriptName} terminal`,
      runScript: (scriptName: string) => `Run ${scriptName} script`,
      previewScript: (scriptName: string) => `Preview ${scriptName} service`,
    ...
    gitDiff: {
      ...
      commitFilesLabel: "Files to commit",
      commitFilesSelected: (selected: number, total: number) =>
        `${selected}/${total} files selected`,
      commitFilesRequired: "Select at least one file",
      selectAllCommitFiles: "Select all",
      clearCommitFiles: "Clear",
      hostNotConnected: "Host is not connected",
      magicCommitAction: "Ask agent to commit",
      magicCommitSent: "Sent commit request to agent",
      magicCommitFailed: "Failed to send commit request",
      magicCommitNoFocusedAgent: "Focus an agent in this workspace first",
      magicCommitUnsupported: "This host version does not support hidden sends",
      newFileBadge: "New",
      deletedFileBadge: "Deleted",
      binaryFileBadge: "Binary",
      cancelCommit: "Cancel",
      pullAction: "Pull",
      pulling: "Pulling...",
      pushAction: "Push",
    ...
    settings: {
      ...
      resetEnvironmentTitle: "Reset Paseo",
      resetEnvironmentHint:
        "Clear Paseo app and daemon state on this device and return to the first-run flow. Your project repositories and external agent credentials are not deleted.",
      resetEnvironmentAction: "Reset",
      resettingEnvironment: "Resetting...",
      resetEnvironmentConfirmMessage:
        "This stops the built-in daemon and clears saved Paseo hosts, agents, worktree records, drafts, attachment cache, and settings on this device. Your project repositories will not be deleted.",
      resetEnvironmentFailed: (message: string) => `Reset failed: ${message}`,
      shortcuts: {
        title: "Shortcuts",
      ...
      providers: {
        ...
        installSucceeded: (name: string, version: string) => `${name} installed, now ${version}`,
        installSucceededUnknownVersion: (name: string) => `${name} installed`,
        installNotDetected: (name: string) =>
          `The ${name} install command finished, but the executable still isn't detected — check the diagnostic below`,
        installUnchanged: (name: string, version: string) =>
          `The ${name} install command finished, but the version is still ${version}`,
        installOnDesktopOnly:
          "Automatic install is desktop-only. Copy the command below and run it in a terminal on that host.",
        ...
        capabilityLabels: {
          ...
          supportsSessionPersistence: "Resume sessions",
          supportsDynamicModes: "Dynamic modes",
          supportsMcpServers: "MCP",
          supportsReasoningStream: "Reasoning stream",
          supportsToolInvocations: "Tool calls",
        },
        supported: "Supported",
        unsupported: "Unsupported",
      },
      externalImport: {
        title: "Import external endpoints",
        subtitle:
          "Read-only import from cc-switch and Cherry Studio. Their own configuration is never modified.",
        sources: { ccswitch: "cc-switch", "cherry-studio": "Cherry Studio" },
        notDetected: "Not detected",
        readFrom: (path: string) => `Read from ${path}`,
        scan: "Scan",
        scanning: "Scanning...",
        nothingFound: "No importable endpoints found",
        nothingFoundHint: "Check that those apps are installed and have at least one endpoint.",
        ...
        overwriteHint: (count: number) =>
          `${count} of the selected endpoints share a name with an existing one. Pressing again overwrites their URL and key, but keeps the default flag.`,
        imported: (count: number) => `Imported ${count} endpoints`,
        importFailed: "Import failed",
        clear: "Clear",
      },
      automation: {
        title: "Automations",
        subtitle: "Run agent tasks on a schedule. Each run becomes a normal session.",
        unsupported: "Connect to the local daemon to manage automations.",
        empty: "No automations yet",
        emptyHint: "Create one to have an agent run a task for you on a schedule.",
        loadFailed: "Couldn't load automations",
        create: "New",
        creating: "Creating...",
        cancel: "Cancel",
        save: "Save",
        namePlaceholder: "e.g. Check dependency updates",
        promptPlaceholder: "Describe exactly what the agent should do, its limits and output",
        nameLabel: "Name",
        promptLabel: "Task",
        ...
        timezoneNote: (zone: string) =>
          `Runs in this machine's timezone (${zone}). Missed runs while the app is closed are skipped.`,
        nextRun: (time: string) => `Next run ${time}`,
        nextRunUnknown: "Next run pending",
        paused: "Paused",
        active: "Active",
        pause: "Pause",
        resume: "Resume",
        ...
        deleteHint: (name: string) =>
          `Press again to delete "${name}". Sessions it already created are kept.`,
        lastRun: (time: string) => `Last ${time}`,
        runStatuses: { running: "Running", succeeded: "Succeeded", failed: "Failed" },
        promptRequired: "The task can't be empty",
        weekdayNames: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        summary: {
          everyMinutes: (minutes: number) => `Every ${minutes}m`,
          ...
          monthly: (day: number, time: string) => `Day ${day} at ${time}`,
          cron: (expression: string) => `Custom (${expression})`,
        },
      },
      usage: {
        title: "Usage",
        subtitle:
          "Tokens, duration and cost across every agent on this machine, including bring-your-own-key traffic.",
        unsupported: "This daemon doesn't report local usage yet. Update it to enable this screen.",
        scope: (range: string, project: string) => `Showing ${range} · ${project}`,
        ranges: { 1: "Today", 7: "7 days", 30: "30 days", 90: "90 days", all: "All" },
        allProviders: "All agents",
        allProjects: "All projects",
        refresh: "Refresh",
        empty: "No usage recorded yet",
        emptyHint: "Run a conversation and tokens, duration and cost will show up here.",
        noMatching: "No usage in this range",
        loadFailed: "Couldn't load usage",
        cards: {
          turns: "Turns",
          turnsHint: (count: number) => `${count} completed requests`,
          tokens: "Tokens",
          tokensHint: (input: string, output: string) => `In ${input} / out ${output}`,
          cached: "Cache reads",
          cachedHint: "Input tokens served from cache",
          duration: "Duration",
          durationHint: "Accumulated per completed turn",
          cost: "Cost",
          costHint: "As reported by each agent",
        },
        trend: "Trend",
        trendHint: "Switches between daily, weekly and monthly buckets with the range",
        metrics: { tokens: "Tokens", cost: "Cost", duration: "Duration" },
        byProvider: "By agent",
        byProject: "By project",
        noProviderRecords: "No agent usage yet",
        noProjectRecords: "No project usage yet",
        bucketSummary: (turns: number) => `${turns} ${turns === 1 ? "turn" : "turns"}`,
      },
      accessProviderTargets: {
        claude: "Claude Code",
        codex: "Codex",
